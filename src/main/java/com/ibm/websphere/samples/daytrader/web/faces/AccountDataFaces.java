...
public class AccountDataFaces {
  ...
  @Inject 
  public AccountDataFaces(@Any Instance<TradeServices> services) {
    ...
    try {
      ...
      if (TradeConfig.getDisplayOrderAlerts()) {
        ...
        if (closedOrders != null && closedOrders.size() > 0) {
          ...
          OrderData[] orderFaces = new OrderData[closedOrders.size()];
      ...
      if (orderDataBeans != null && orderDataBeans.size() > 0) {
        ...
        OrderData[] orderFaces = new OrderData[orderDataBeans.size()];
