  ...
  public void updateConfig() {
    ...
    if (orderProcessingModeStr != null) {
      try {
        ...
        Log.error(e, "TradeConfigFaces.updateConfig(..): minor exception caught", "trying to set orderProcessing to " + orderProcessingModeStr,
    ...
    if (webInterfaceStr != null) {
      try {
        ...
        Log.error(e, "TradeConfigFaces.updateConfig(..): minor exception caught", "trying to set WebInterface to " + webInterfaceStr,
            "reverting to current value");
