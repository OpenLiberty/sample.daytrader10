...
@RequestScoped
@Trace
public class MarketSummaryFaces {
  ...
  @Inject 
  public MarketSummaryFaces(@Any Instance<TradeServices> services) {
  ...
  public void getMarketSummary() {
    ...
    try {
      ...
      int count = 0;
      QuoteData[] gainerFaces = new QuoteData[5];
      ...
      setTopGainers(gainerFaces);

      Collection<?> topLosers = marketSummaryData.getTopLosers();

      QuoteData[] loserFaces = new QuoteData[5];
      count = 0;
