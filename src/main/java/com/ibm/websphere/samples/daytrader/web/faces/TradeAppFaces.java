...
@SessionScoped
@Trace
public class TradeAppFaces implements Serializable {
  ...
  @Inject 
  public TradeAppFaces(@Any Instance<TradeServices> services) {
  ...
  public String logout() {
    ...
    try {
      ...
      Log.error(e, "TradeAppFaces.logout():", "Error logging out" + userID, "fowarding to an error page");
    }
    ...
    try {
      ...
      Log.error(e, "TradeAppFaces.logout():", "Error logging out request" + userID, "fowarding to an error page");
    }
