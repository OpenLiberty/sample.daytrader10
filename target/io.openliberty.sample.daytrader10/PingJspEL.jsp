...
<body>
    ...
    <%
        ...
        pageContext.setAttribute("someint1", someint1);
        int someint2 = TradeConfig.rndInt(100) + 1;
        pageContext.setAttribute("someint2", someint2);
        float somefloat1 = TradeConfig.rndFloat(100) + 1.0f;
        pageContext.setAttribute("somefloat1", somefloat1);
        float somefloat2 = TradeConfig.rndFloat(100) + 1.0f;
        pageContext.setAttribute("somefloat2", somefloat2);
