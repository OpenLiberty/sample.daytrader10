                                                ...
                                                try {
                                                    while (it.hasNext()) {
                                                        ...
                                                        if (basis.doubleValue() == 0.0) {
                                                            ...
                                                            gainPercent = marketValue.divide(basis, RoundingMode.HALF_UP).subtract(new BigDecimal(1.0)).multiply(new BigDecimal(100.0));
                                            %>
                                            <TR bgcolor="#fafcb6"
                                                align="center">
